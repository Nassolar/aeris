...
export default function IndigencyCertScreen() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.pageTitle}>Indigency Certificate</Text>
      </View>
      <View style={styles.stub}>
        ...
        <Text style={styles.stubBody}>
          Online requests for Indigency Certificates will be available once your LGU activates
          this service.
        </Text>
      </View>
    </SafeAreaView>
