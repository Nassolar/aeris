...
export default function BarangayClearanceScreen() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.pageTitle}>Barangay Clearance</Text>
      </View>
      <View style={styles.stub}>
        ...
        <Text style={styles.stubBody}>
          Online Barangay Clearance requests will be available once your LGU activates this service.
        </Text>
      </View>
    </SafeAreaView>
  );
